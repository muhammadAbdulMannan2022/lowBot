      ...
      {!isLiveChat ? (
        <div className="max-w-xl mx-auto p-8 border border-blue-300 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            >
              <span className="font-medium">1.</span> Continue Chating With Ai
              Agent
            </button>
            ...
            <button
              ...
              className="w-full py-4 px-6 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200"
            >
              <span className="font-medium">2.</span> Request a live chat with
              an expert
            </button>
            ...
            <button
              ...
              className="w-full py-4 px-6 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200"
            >
              <span className="font-medium">3.</span> Request an online meeting
              with an expert
            </button>
          </div>
        </div>
      ) : (
        <div className="border border-blue-200 rounded-2xl py-3 px-2">
          <h1 className="text-xl text-gray-600 font-bold text-center">
            A consultant will contact you very soon.
          </h1>
        </div>
      )}
    </>
