...
export default function Sidebar({
	...
	return (
		<>
			...
			<div
				className={cn(
					'fixed inset-y-0 left-0 w-72 bg-gradient-to-b from-white to-[#DCEBF9] border-r flex flex-col px-5 h-screen transition-transform duration-300 ease-in-out md:z-0 z-40',
					isSidebarOpen ? 'translate-x-0' : '-translate-x-full',
					'md:translate-x-0 md:static md:h-[93vh]' // Static on medium screens and up
				)}>
				{/* Logo and User Info */}
				...
				<div className="p-4 border-t">
					<Button
						variant="ghost"
						className="w-full justify-start bg-[#C3DAEF] text-gray-700 hover:bg-blue-100"
						onClick={() => {
