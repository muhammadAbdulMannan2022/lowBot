		...
		<div className="flex flex-col h-screen bg-[#f0f7ff]">
			...
			<div className="flex flex-1 overflow-hidden mt-16">
				...
				<div className="flex-1 overflow-y-auto p-4 md:p-6 md:pl-7">
					...
					<div className="bg-gray-100 rounded-lg p-4 mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
						<div className="text-center md:text-left">
							<p className="text-sm text-gray-600">Date of Starting</p>
						...
						<div className="text-center md:text-right">
							<p className="text-sm text-gray-600">Date of End</p>
							<p className="font-medium text-sm md:text-base">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
						{plans.length > 0 ? (
										...
										<Button
											...
											className={`w-full py-2 rounded-md border ${
												plan.name === currentPlan.plan?.name
													...
													: 'bg-white border-blue-600 hover:bg-blue-700 hover:text-white'
										...
										<div className="mt-4 md:mt-6 space-y-2 md:space-y-3">
											{plan.features.map((feature) => (
												<div key={feature.name} className="flex items-start">
													{feature.included ? (
														<Check className="h-4 w-4 md:h-5 md:w-5 text-blue-600 mr-2 flex-shrink-0" />
													) : (
							...
							<p className="text-center col-span-1 md:col-span-3 text-gray-600">
