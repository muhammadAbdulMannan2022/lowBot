		...
		<div className="flex flex-col h-screen bg-[#f0f7ff]">
			<div className="flex flex-1 overflow-hidden md:mt-16 mt-32">
				...
				<div className="flex-1 overflow-y-auto p-4 md:p-6 md:pl-7">
					{/* Profile Header */}
					<Card className="mb-6 border-blue-500 border">
								...
								<div className="flex flex-col flex-1 gap-4">
									<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
										...
										<Button
											...
											variant="outline"
											className="w-full md:w-auto flex items-center gap-1 hover:bg-blue-500 hover:text-white"
											aria-label="Edit profile">
											Edit <Pencil className="h-3.5 w-3.5 ml-1" />
										</Button>
									</div>
									<div>
										<h2 className="font-medium mb-1 text-sm md:text-base">
											About me
										</h2>
					...
					<Card>
						...
						<CardContent>
							<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
								<div>
									<p className="text-sm text-slate-500 mb-1">House No.</p>
									<p className="font-medium text-sm md:text-base">
										{profile.house_no || 'N/A'}
									</p>
								</div>
								<div>
									<p className="text-sm text-slate-500 mb-1">Road No.</p>
									<p className="font-medium text-sm md:text-base">
										{profile.road_no || 'N/A'}
									</p>
								</div>
