...
export default function UserMeetings() {
  ...
  const handleDeleteMeeting = async (meetingId) => {
    setLoading(true);
    try {
      await axiosInstance.delete(`/api/auth/meetings/${meetingId}/`);
      setMeetings((prev) =>
  ...
  return (
    <Sidebar>
      <div className="flex px-4 flex-col h-screen bg-[#f0f7ff] dark:bg-gray-900">
        <div className="flex flex-1 overflow-hidden mt-16">
          {/* Sidebar */}

          {/* Main Content */}
          <div className="flex-1 overflow-y-auto p-4 md:pl-2">
            <h1 className="text-xl font-semibold text-center mb-6 text-slate-800 dark:text-white">
              Meetings
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <Card className="dark:bg-gray-800">
                <CardContent className="flex items-center justify-between p-4 dark:text-white">
                  <div>
            ...
            <div className="bg-white dark:bg-gray-800 dark:text-white rounded-lg shadow-sm">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center p-4 border-b gap-4">
                  ...
                  <div className="relative w-full md:w-auto">
                    ...
                    <Input
                      ...
                      className="pl-8 h-9 w-full md:w-[200px] lg:w-[300px] dark:bg-gray-900 dark:text-white"
